...
<body>
	<form>
		...
		<table>
			<tr>
				<td colspan="2">
					<input type="text" name="Anda" placeholder="Masukkan Nama Anda" class="utama" autocomplete="off" style="margin-top: 25px;" autofocus="on">
				</td>
			</tr>
			<tr>
				<td><input type="text" name="hp" placeholder="Masukkan No Hp Anda" class="utama" autocomplete="off"></td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td colspan="2">
					<input type="" name="" disabled="" placeholder="kategori" class="utama3">
					<select name="kategori" class="utama4">
